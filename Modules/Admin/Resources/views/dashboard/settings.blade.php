              ...
              <div class="alert js-alert margin-bottom-lg alert--is-visible" role="alert"> <!-- /.alert--is-visible -->
                <div class="flex items-center justify-between">
                  <div class="flex items-center">
                    ...
                    <div class="alert-message">{{ session()->get('posts-settings-alert') }}</div><!-- /.alert-message -->
                  </div>
                </div>
              </div>
            @endif

            <form action="{{ (is_null($posts_settings)) ? route('admin.dashboard.settings.store') : route('admin.dashboard.settings.update') }}" method="post">
                @csrf
