        ...
        <div class="grid">
          ...
          <div class="box-footer">
            <menu class="menu-bar menu-bar--expanded@md js-menu-bar margin-xs">
              ...
              <li class="menu-bar__item btn-load-box {{ $type == 'post' ? 'menu-control--active' : '' }}" role="menuitem" box-type="post">
              ...
              <li class="menu-bar__item btn-load-box {{ $type == 'page' ? 'menu-control--active' : '' }}" role="menuitem" box-type='page'>
