<!-- 👇 Full Screen Modal -->
<form action="#" id="formEditGif">
  @csrf
  <input type="hidden" id="gifId" value="">
  <div class="custom-modal modal modal--animate-translate-down flex flex-center bg-contrast-higher bg-opacity-90% padding-md js-modal custom-modal-hide-body-scroll custom-disable-modal-close" id="modal-edit-gif">
          ...
          <!--Tab2 Content-->
            <section id="tab1Panel2" class="padding-top-md js-tabs__panel">
              ...
              <div class="file-upload inline-block">
                ...
                <input type="file" class="file-upload__input" name="thumbnail" accept="image/gif" id="editThumbnail">
              </div>
            </section>
                ...
                <fieldset class="margin-bottom-md">
                  ...
                  <div class="grid gap-sm">
                    ...
                    <div>
                      ...
                      <div class="gif-tag-wrp edit-post-tag margin-top-lg">
