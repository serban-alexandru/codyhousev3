<div class="bg radius-md padding-md shadow-sm">
  ...
  <form action="{{route('admin.gifs.delete.multiple')}}"
            ...
            <tr class="int-table__row">
              ...
              <td class="int-table__cell cursor-pointer" aria-controls="modal-edit-gif" data-id="{{ $gif->id }}">
                <a href="#0">
                  ...
                  <p class="text-component text-xs color-contrast-medium">By: {{ $gif->username }}</p>
                </a>
              </td>
              ...
              @elseif($gif->is_deleted)
                ...
                <td class="int-table__cell text-center" style="overflow: unset;">
                  <form action="{{ route('admin.gifs.delete-permanently') }}" method="post">
                    @csrf
                    <input type="hidden" name="post_id" value="{{ $gif->id }}">
