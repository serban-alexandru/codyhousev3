  ...
  <nav class="sidenav padding-y-sm text-sm@md js-sidenav">
    ...
    <ul class="sidenav__list">
      ...
      <li class="sidenav__item sidenav__item--expanded">
        <a href="{{ url('/gifs') }}" class="sidenav__link ajax-link"{{ (url('/gifs') == url()->full()) ? 'aria-current=page' : '' }}>
    ...
    <ul class="sidenav__list">
      <li class="sidenav__item">
        <a href="{{ url('/gifs/settings') }}" class="sidenav__link"{{ (url('/gifs/settings') == url()->full()) ? 'aria-current=page' : '' }}>
