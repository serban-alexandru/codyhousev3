  ...
  <nav class="sidenav padding-y-sm text-sm@md js-sidenav">
    ...
    <ul class="sidenav__list">
      <li class="sidenav__item sidenav__item--expanded">
        <a href="{{ url('/pages') }}" class="sidenav__link ajax-link"{{ (url('/pages') == url()->full()) ? 'aria-current=page' : '' }}>
        ...
        <ul class="sidenav__list">
          <li class="sidenav__item">
            <a href="{{ url('/pages?is_draft=1') }}" class="sidenav__link ajax-link">
          ...
          <li class="sidenav__item">
            <a href="{{ url('/pages?is_pending=1') }}" class="sidenav__link ajax-link">
          ...
          <li class="sidenav__item">
            <a href="{{ url('/pages?is_trashed=1') }}" class="sidenav__link ajax-link">
