...
<div class="bg radius-md padding-md shadow-sm">
  <div class="margin-bottom-xl">
    <div class="flex flex-wrap gap-sm items-center justify-between">
        <ul class="flex flex-wrap gap-xs" style="width: 100%;">
          <li class="menu-bar__item js-menu-bar has-text modal-trigger-add-user" aria-controls="modal-add-user" role="menuitem" data-href="{{ url('admin/users/add') }}">
            ...
            <span class="display@md padding-xxxs">Add Users</span>
          ...
          <li class="menu-bar__item" style="margin-left: auto; margin-right: 45px;">
      ...
      <div class="menu-bar__item hide@md no-js:is-hidden" aria-controls="sidebar">
