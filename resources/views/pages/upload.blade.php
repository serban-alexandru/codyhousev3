...
<div class="container max-width-adaptive-lg margin-top-md">
  <form>
    <fieldset class="margin-bottom-md">
      <legend class="form-legend">Upload Content</legend>
      ...
      <div class="margin-bottom-sm">
        ...
        <div role="alert" class="form-error-msg form-error-msg--is-visible"><p><strong>Error:</strong> this is an error message</p></div>
      </div>
    ...
    <fieldset class="margin-bottom-md">
      ...
      <div class="checkbox-list flex flex-wrap gap-md">
        <div>
