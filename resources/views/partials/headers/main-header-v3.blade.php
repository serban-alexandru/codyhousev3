<header class="dr-nav-header margin-bottom-xl">
    <div class="container position-relative height-100% flex items-center max-width-adaptive-lg">
      ...
      <ul class="radio-switch ">
        <li class="radio-switch__item">
          <input class="radio-switch__input sr-only" type="radio" name="radio-switch-name" id="radio-1" value="" checked>
        ...
        <li class="radio-switch__item">
          <input class="radio-switch__input sr-only" type="radio" name="radio-switch-name" id="radio-2" value="">
  ...
  <div class="dr-nav-control-wrapper">
    <div class="container max-width-adaptive-lg height-100% flex items-center">
