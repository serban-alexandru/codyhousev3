    ...
    <div class="author author--featured">
      ...
      @if($user->account_setting)
        <div class="author__content text-component">
          <p>{{ $user->account_setting->bio }}</p>
        </div>

        @if($user->hasSocialMedia())
          <ul class="flex gap-xs flex-wrap justify-center">
            @if(!is_null($user->account_setting->twitter_link))
              <li>
                <a href="{{ $user->account_setting->twitter_link }}" class="author__social">
            ...
            @if(!is_null($user->account_setting->facebook_link))
              <li>
                <a href="{{ $user->account_setting->facebook_link }}" class="author__social">
            ...
            @if(!is_null($user->account_setting->instagram_link))
              <li>
                <a href="{{ $user->account_setting->instagram_link }}" class="author__social">
