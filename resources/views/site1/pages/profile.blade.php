    ...
    <div class="author author--featured">
      ...
      @if(auth()->user()->account_setting)
        <div class="author__content text-component">
          <p>{{ auth()->user()->account_setting->bio }}</p>
        </div>

        @if(auth()->user()->hasSocialMedia())
          <ul class="flex gap-xs flex-wrap justify-center">
            @if(!is_null(auth()->user()->account_setting->twitter_link))
              <li>
                <a href="{{ auth()->user()->account_setting->twitter_link }}" class="author__social">
            ...
            @if(!is_null(auth()->user()->account_setting->instagram_link))
              <li>
                <a href="{{ auth()->user()->account_setting->instagram_link }}" class="author__social">
...
<div class="text-divider padding-bottom-xs text-lg"><span>Olivia Gribben's Content</span></div>
